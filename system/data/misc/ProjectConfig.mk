...
CUSTOM_HAL_IMGSENSOR = gc2755_mipi_raw imx219_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = gc2755_mipi_raw imx219_mipi_raw
...
DISABLE_EARPIECE = no
DROI_AUTO_MAC_SUPPORT = yes
DROI_AVOID_ICON_OVERLAP = yes
DROI_CUSTOM_BT_NAME = Archos 50 Saphir
DROI_CUSTOM_TIMEZONE = Europe/London
DROI_CUSTOM_WLAN_SSID = Archos 50 Saphir
DROI_FREEMEOS_LITE_BROWSER = no
DROI_FREEMEOS_LITE_CALCULATOR = no
DROI_FREEMEOS_LITE_CALENDAR = no
DROI_FREEMEOS_LITE_CAMERA = no
DROI_FREEMEOS_LITE_CAMERA_ChILDRENMODE = no
DROI_FREEMEOS_LITE_CAMERA_LARGEMODE = no
DROI_FREEMEOS_LITE_CAMERA_POSEMODE = no
DROI_FREEMEOS_LITE_CAMERA_WATERMARKMODE = no
DROI_FREEMEOS_LITE_CLEARTASK = no
DROI_FREEMEOS_LITE_DESKCLOCK = no
DROI_FREEMEOS_LITE_FILEMANAGER = no
DROI_FREEMEOS_LITE_LAUNCHER = no
DROI_FREEMEOS_LITE_MUSIC = no
DROI_FREEMEOS_LITE_VIDEO = no
DROI_FREEMEOS_LITE_WEATHER = no
DROI_MMI_AUTO_IMEI_SUPPORT = yes
DROI_MORE_RING_OPTION = yes
DROI_MTP_PTP_NAME = Archos 50 Saphir
DROI_POWEROFF_ANI_SUPPORT = no
DROI_SF_LCD_DENSITY = 280
DROI_THREE_POINTER_SHOT = no
DROI_VENDOR_APP = yes
...
FREEME_CHANNEL_NO = droi01
FREEME_CUSTOMER_BRANCH = 1
FREEME_CUSTOMER_NO = fq5c62aks
FREEME_CUSTOM_HW_VERNO = fq5c62wt
...
FREEME_FACTORYMODE_FINGER_PRIN = no
FREEME_FACTORYMODE_FINGER_PRINT = no
...
FREEME_FACTORYMODE_MSENSOR = yes
FREEME_FACTORYMODE_OTG = yes
...
FREEME_MOTION_SETTINGS = no
FREEME_NAVIGATIONBAR_SHOW = no
FREEME_OTA_FLASH = null
FREEME_OTA_LANGUAGE = zh
FREEME_OTA_SUPPORT = no
FREEME_PRODUCT_BRAND = archos
FREEME_PRODUCT_DEVICE = fq5c
FREEME_PRODUCT_MODEL = AC50SA
FREEME_PRODUCT_NAME = QCAC50SA
FREEME_SMART_LEATHERCASE_MODE_SUPPORT = no
FREEME_SMART_WAKE_HOMEKEY_SUPPORT = no
FREEME_SMART_WAKE_SUPPORT = no
FREEME_SUPERSHOT_SUPPORT = no
FREEME_TARGET_DEVICE = ac50sa
GEMINI = yes
...
MTK_BUILD_VERNO = alps-mp-m0.mp1-V2.84_droi6737t.36.m0
MTK_BWC_SUPPORT = yes
...
TYD_CUSTOM_SW_BUILD_VERNO = AC50SA_ARCHOS_V1.10_20180420
TYD_CUSTOM_SW_PRIVATE_VERNOH = FQ5C62WTE1D.AKS.M0.HB.H.SSXSSYDAKLS23.0420.V3.09
TYD_DROI_PROJECT_BRANCH = droi6737t_36_m0
TYD_MMI_FLASH_TYPE = EMMC_1616_DDR3
TYD_POWEROFF_NO_AUDIO = yes
TYD_POWERON_NO_AUDIO = yes
TYD_SECURITY_FLOAT_MANAGER = yes
TYD_SECURITY_GETAPPLIST = yes
TYD_SECURITY_RECEIVER_MANAGER = yes
TYD_SVN_REVISION = 25542
